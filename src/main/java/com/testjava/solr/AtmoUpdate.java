...
public class AtmoUpdate {
    ...
    private static String sendHttpMessage(String url, String method, String contents) {
        try {
            ...
            conn.addRequestProperty("Content-type", "application/com.testjava.json");
    ...
    public static void main(String[] args) throws SolrServerException, IOException {
        ...
        AtmoUpdate atmoUpdate = new AtmoUpdate("http://123.58.179.61:8080/com.testjava.solr");
        //atmoUpdate.AddIndex();
...
//            add.put("add", "lily"); //{"add":"Cyberpunk"}
            ...
            json.put("id", set);
//            com.testjava.json.put("editor", inc);
//            com.testjava.json.put("editor_3g", add);
            content.add(json);
