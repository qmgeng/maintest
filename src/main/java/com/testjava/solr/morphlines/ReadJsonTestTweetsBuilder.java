package com.testjava.solr.morphlines;
...
public final class ReadJsonTestTweetsBuilder implements CommandBuilder {
    ...
    //public static final String MEDIA_TYPE = "mytwittertest/com.testjava.json+delimited+length";
                ...
                while (true) {
                    ...
                    if (isLengthDelimited) {
                        ...
                        try {
                            ...
                            LOG.info("com.testjava.json parse exception after " + numRecords + " records");
                            LOG.debug("com.testjava.json parse exception after " + numRecords + " records", e);
                            break;
                        }
                    } else {
                        if (!iter.hasNext()) {
