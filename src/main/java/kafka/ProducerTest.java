...
public class ProducerTest {
    public static String BROKER_CONNECT = "";
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        props.put("metadata.broker.list", BROKER_CONNECT);
        ...
        for (int i = 0; i <= 1000000; i++) {
            KeyedMessage<String, String> message = new KeyedMessage<String, String>(TOPIC, i + "", "Message" + i);
